...
Graph-backed agentic RAG system. FastAPI + LangGraph + Neo4j + Pinecone + Redis + Codex.
...
5. **synthesizer** — Codex grounded answer with source attribution and cost calculation
